...
public class DateFormat {
	...
	/**
	 * This methead create new dateformat object if format is new or find
	 * suiltable dateformat object to minimize memroy in use.
	 * 
	 * @param format
	 *            String
	 * @return String
	 ...
	 * @return String
	 */
	public static synchronized String easyDateFormat(String format, Date date) {
		if (date == null) {
			return "";
		}
